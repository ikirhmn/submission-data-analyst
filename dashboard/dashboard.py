...
# Load dataset
day_df = pd.read_csv("C:\\Users\\LENOVO\proyek_analisis_data\\submission\\data\\day.csv")
hour_df = pd.read_csv("C:\\Users\\LENOVO\\proyek_analisis_data\\submission\\data\\hour.csv")
